    ...
    <div class="flex-1 bg-purple-400 p-8 overflow-auto">
        <div class="max-w-2xl mx-auto">
            <div class="flex items-center mb-8">
                ...
                <h2 class="text-2xl text-white font-bold">Ajouter un compte</h2>
            </div>
                ...
                <form method="POST" action="{{ route('comptes.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <select name="type" id="type" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-purple-500" required>
                            ...
                            <option value="investissement" {{ old('type') == 'investissement' ? 'selected' : '' }}>Investissement</option>
                        </select>
                    </div>

                    <div class="mb-6">
                        <label for="solde_initial" class="block text-gray-700 text-sm font-bold mb-2">Solde initial</label>
                        <input type="number" step="0.01" name="solde_initial" id="solde_initial" value="{{ old('solde_initial', '0') }}" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-purple-500" required>
                    </div>
